...
public class VideoPlayerForm: Form {
    ...
    private IGraphBuilder graphBuilderPrimary = default!;
    private IGraphBuilder graphBuilderSecondary = default!;
    private IMediaControl mediaControlPrimary = default!;
    private IMediaControl mediaControlSecondary = default!;
    private static IBaseFilter videoRendererSecondary = default!;
    private static IBaseFilter videoRendererPrimary = default!;
    private IBaseFilter lavSplitterPrimary = default!;
    private IBaseFilter lavSplitterSecondary = default!;
    private IBaseFilter lavVideoDecoderPrimary = default!;
    private IBaseFilter lavVideoDecoderSecondary = default!;
    private static IBaseFilter lavAudioDecoderSecondary = default!;
    private IPin outputPinSecondary = default!;
    private static IBaseFilter audioRenderer = default!;
    private IVideoWindow videoWindowSecondary = default!;
    private IVideoWindow videoWindowPrimary = default!;
    private IMediaEventEx mediaEventExPrimary = default!;
    private IMediaEventEx mediaEventExSecondary = default!;
        ...
        Task.Run(async () => {
            while (true) {
                try {
                    ...
                    // 只檢查播放進度
                    IMediaSeeking mediaSeekingSecondary = (IMediaSeeking)graphBuilderSecondary;
