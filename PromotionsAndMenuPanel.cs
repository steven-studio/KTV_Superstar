...
{
    public ImagePanel prevPagePanel = default!;
    public ImagePanel currentPagePanel = default!;
    public ImagePanel nextPagePanel = default!;

    private List<Image> promotionsAndMenuImages = default!;
