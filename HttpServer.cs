...
public class HttpServer
{
    ...
    // 服务器类变量
    private static SongListManager songListManager = default!;
    // 使用完整命名空间来避免歧义
    public static event ActionString OnDisplayBarrage = default!;
    private static DateTime lastClickTime = DateTime.MinValue;
    public static string randomFolderPath = default!; // 声明全局变量
    private static OverlayForm form = default!;
