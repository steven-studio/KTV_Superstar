...
{
    private PictureBox pictureBoxZhuYinSingers = default!;

    private Button[] phoneticButtonsForSingers = default!;
    private Button modifyButtonZhuYinSingers = default!;
    private Button clearButtonZhuYinSingers = default!;
    private Button closeButtonZhuYinSingers = default!;

    private string[] phoneticSymbols = default!;
    private (int X, int Y, int Width, int Height)[] phoneticButtonCoords = default!;
    private Dictionary<string, (string normal, string mouseDown, string mouseOver)> phoneticButtonImages = default!;
    ...
    private RichTextBox inputBoxZhuYinSingers = default!;

    private (int X, int Y, int Width, int Height) inputBoxZhuYinCoords;
    private string inputBoxFontName = default!;
