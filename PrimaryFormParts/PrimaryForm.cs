...
public partial class PrimaryForm : Form
{
    ...
    private PictureBox pictureBox1 = default!;
    private PictureBox pictureBox2 = default!;
    private PictureBox pictureBox3 = default!;
    private PictureBox pictureBox4 = default!;
    private PictureBox pictureBox5 = default!;
    private PictureBox pictureBox6 = default!;

    private const int offsetX = 100;

    private PictureBox pictureBoxArtistSearch = default!;

    private Button[] numberButtonsArtistSearch = default!;
    private Button modifyButtonArtistSearch = default!, closeButtonArtistSearch = default!;
    private RichTextBox inputBoxArtistSearch = default!;
    private const int offsetXArtistSearch = 100; 
    private const int offsetYArtistSearch = 100; 

    private PictureBox pictureBoxWordCount = default!;

    private Button[] numberButtonsWordCount = default!;
    private Button modifyButtonWordCount = default!, closeButtonWordCount = default!;
    private RichTextBox inputBoxWordCount = default!;
    private const int offsetXWordCount = 100;
    private const int offsetYWordCount = 100;

    private PictureBox pictureBoxSongIDSearch = default!;

    private Button[] numberButtonsSongIDSearch = default!;
    private Button modifyButtonSongIDSearch = default!, closeButtonSongIDSearch = default!;
    private RichTextBox inputBoxSongIDSearch = default!;
    private const int offsetXSongID = 100;
    private const int offsetYSongID = 100;
    private const int offsetXPinYin = 100;

    private Button singerSearchButton = default!;
    private Bitmap singerSearchNormalBackground = default!;
    private Bitmap singerSearchActiveBackground = default!;
    private Button songSearchButton = default!;
    private Bitmap songSearchNormalBackground = default!;
    private Bitmap songSearchActiveBackground = default!;
    private Button serviceBellButton = default!;
    private Button deliciousFoodButton = default!;
    private Bitmap deliciousFoodNormalBackground = default!;
    private Bitmap deliciousFoodActiveBackground = default!;
    private Button mobileSongRequestButton = default!;
    private Button qieGeButton = default!;
    private Button musicUpButton = default!;
    private Button musicDownButton = default!;
    private Button micUpButton = default!;
    private Button micDownButton = default!;
    private Button originalSongButton = default!;
    private Button replayButton = default!;
    public Button pauseButton = default!;
    public Button playButton = default!;
    private Button muteButton = default!;
    private Button maleKeyButton = default!;
    private Button femaleKeyButton = default!;
    private Button standardKeyButton = default!;
    private Button soundEffectButton = default!;

    private Button pitchUpButton = default!;
    private Button pitchDownButton = default!;
    private Button syncScreenButton = default!;
    private Button toggleLightButton = default!;

    private PictureBox promotionsPictureBox = default!;

    private List<Image> promotions = default!;
    private List<Image> menu = default!;

    private PictureBox VodScreenPictureBox = default!;

    private Panel overlayPanel = default!;

    private Button btnPreviousPage = default!;
    private Button btnReturn = default!;
    private Button btnNextPage = default!;
    private Button btnApplause = default!;
    private Button btnSimplifiedChinese = default!;
    private Button btnTraditionalChinese = default!;
    private Button exitButton = default!;
    
    private static Bitmap normalStateImage = default!;
    private static Bitmap mouseOverImage = default!;
    private static Bitmap mouseDownImage = default!;

    
    private static Bitmap resizedNormalStateImage = default!;
    private static Bitmap resizedMouseOverImage = default!;
    private static Bitmap resizedMouseDownImage = default!;

    private static Bitmap normalStateImageNewSongAlert = default!;
    private static Bitmap mouseOverImageNewSongAlert = default!;
    private static Bitmap mouseDownImageNewSongAlert = default!;

    private static Bitmap resizedNormalStateImageForNewSongAlert = default!;
    private static Bitmap resizedMouseOverImageForNewSongAlert = default!;
    private static Bitmap resizedMouseDownImageForNewSongAlert = default!;

    private static Bitmap normalStateImageArtistQuery = default!;
    private static Bitmap mouseOverImageArtistQuery = default!;
    private static Bitmap mouseDownImageArtistQuery = default!;

    private static Bitmap resizedNormalStateImageForArtistQuery = default!;
    private static Bitmap resizedMouseOverImageForArtistQuery = default!;
    private static Bitmap resizedMouseDownImageForArtistQuery = default!;

    private static Bitmap normalStateImageSongQuery = default!;
    private static Bitmap mouseOverImageSongQuery = default!;
    private static Bitmap mouseDownImageSongQuery = default!;

    private static Bitmap resizedNormalStateImageForSongQuery = default!;
    private static Bitmap resizedMouseOverImageForSongQuery = default!;
    private static Bitmap resizedMouseDownImageForSongQuery = default!;

    private static Bitmap normalStateImageLanguageQuery = default!;
    private static Bitmap mouseOverImageLanguageQuery = default!;
    private static Bitmap mouseDownImageLanguageQuery = default!;

    private static Bitmap resizedNormalStateImageForLanguageQuery = default!;
    private static Bitmap resizedMouseOverImageForLanguageQuery = default!;
    private static Bitmap resizedMouseDownImageForLanguageQuery = default!;

    private static Bitmap normalStateImage6_1 = default!;
    private static Bitmap mouseOverImage6_1 = default!;
    private static Bitmap mouseDownImage6_1 = default!;

    private static Bitmap resizedNormalStateImageFor6_1 = default!;
    private static Bitmap resizedMouseOverImageFor6_1 = default!;
    private static Bitmap resizedMouseDownImageFor6_1 = default!;

    private static Bitmap normalStateImageCategoryQuery = default!;
    private static Bitmap mouseOverImageCategoryQuery = default!;
    private static Bitmap mouseDownImageCategoryQuery = default!;

    private static Bitmap resizedNormalStateImageForCategoryQuery = default!;
    private static Bitmap resizedMouseOverImageForCategoryQuery = default!;
    private static Bitmap resizedMouseDownImageForCategoryQuery = default!;

    private static Bitmap normalStateImage7_1 = default!;
    private static Bitmap mouseOverImage7_1 = default!;
    private static Bitmap mouseDownImage7_1 = default!;

    private static Bitmap resizedNormalStateImageFor7_1 = default!;
    private static Bitmap resizedMouseOverImageFor7_1 = default!;
    private static Bitmap resizedMouseDownImageFor7_1 = default!;

    private static Bitmap normalStateImage7_1_1 = default!;
    private static Bitmap mouseOverImage7_1_1 = default!;
    private static Bitmap mouseDownImage7_1_1 = default!;

    private static Bitmap resizedNormalStateImageFor7_1_1 = default!;
    private static Bitmap resizedMouseOverImageFor7_1_1 = default!;
    private static Bitmap resizedMouseDownImageFor7_1_1 = default!;

    
    private static Bitmap normalStateImageForPromotionsAndMenu = default!;
    private static Bitmap resizedNormalStateImageForPromotionsAndMenu = default!;

    private static Bitmap normalStateImageForSyncScreen = default!;
    private static Bitmap resizedNormalStateImageForSyncScreen = default!;

    private static Bitmap normalStateImageForSceneSoundEffects = default!;
    private static Bitmap resizedNormalStateImageForSceneSoundEffects = default!;

    private static Bitmap normalStateImageForLightControl = default!;
    private static Bitmap resizedNormalStateImageForLightControl = default!;

    public VideoPlayerForm videoPlayerForm = default!;

    
    public List<SongData> allSongs = default!;
    public List<Artist> allArtists = default!;
    public List<SongData> currentSongList = default!;
    public List<Artist> currentArtistList = default!;
    public List<SongData> publicSongList = default!;
    private List<SongData> guoYuSongs = default!;
    private List<SongData> taiYuSongs = default!;
    private List<SongData> yueYuSongs = default!;
    private List<SongData> yingWenSongs = default!;
    private List<SongData> riYuSongs = default!;
    private List<SongData> hanYuSongs = default!;
    private List<SongData> guoYuSongs2 = default!;
    private List<SongData> taiYuSongs2 = default!;
    private List<SongData> yueYuSongs2 = default!;
    private List<SongData> yingWenSongs2 = default!;
    private List<SongData> riYuSongs2 = default!;
    private List<SongData> hanYuSongs2 = default!;
    private List<SongData> loveDuetSongs = default!;
    private List<SongData> talentShowSongs = default!;
    private List<SongData> medleyDanceSongs = default!;
    private List<SongData> ninetiesSongs = default!;
    private List<SongData> nostalgicSongs = default!;
    private List<SongData> chinaSongs = default!;
    private List<SongData> vietnameseSongs = default!;
    public static List<SongData> userRequestedSongs = default!;
    public static List<SongData> playedSongsHistory = default!;
    public static List<PlayState> playStates = default!;
    public static int currentSongIndexInHistory = -1;
    public MultiPagePanel multiPagePanel = default!;
    ...
    private WaveInEvent waveIn = default!;
    private WaveFileWriter waveWriter = default!;
    ...
    private System.Windows.Forms.Timer lightControlTimer;
    public System.Windows.Forms.Timer volumeUpTimer;
    public System.Windows.Forms.Timer volumeDownTimer;
    private DateTime lastVolumeUpTime = DateTime.MinValue;
    private DateTime lastVolumeDownTime = DateTime.MinValue;
    public System.Windows.Forms.Timer micControlTimer;

    private SequenceManager sequenceManager = new SequenceManager();

    private PictureBox buttonMiddle = default!;
    private PictureBox buttonTopRight = default!;
    private PictureBox buttonTopLeft = default!;
    private PictureBox buttonThanks = default!;
    ...
    private Panel sendOffPanel = default!;
    private PictureBox sendOffPictureBox = default!;

    private static Bitmap normalStateImageHotSong = default!;
    private static Bitmap mouseDownImageHotSong = default!;
    private static Bitmap resizedNormalStateImageForHotSong = default!;
    private static Bitmap resizedMouseDownImageForHotSong = default!;
    ...
    private PictureBox serviceBellPictureBox = default!;  // 添加为类成员变量

    private System.Windows.Forms.Timer autoRefreshTimer = default!;
    ...
    private void InitializeOtherControls()
    {
        ...
        ConfigureButton(qieGeButton, 28, 755, 92, 132, 
            ...
            async (sender, e) => await videoPlayerForm.SkipToNextSong());
...
artistLabel.BringToFront();
    ...
    private SongData currentSelectedSong = default!;
    ...
    public void Label_Click(object sender, EventArgs e)
    {
        ...
        if (label != null && label.Tag is SongData)
        {
            ...
            currentSelectedSong = (SongData)label.Tag;
