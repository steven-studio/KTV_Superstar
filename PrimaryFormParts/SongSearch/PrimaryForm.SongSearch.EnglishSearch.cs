...
{
    private PictureBox pictureBoxEnglishSongs = default!;
    
    private Button[] numberButtonsForSongs = default!;
    private Button[] letterButtonsForEnglishSongs = default!;
    private Button modifyButtonEnglishSongs = default!;
    private Button clearButtonEnglishSongs = default!;
    private Button closeButtonEnglishSongs = default!;
    private RichTextBox inputBoxEnglishSongs = default!;
