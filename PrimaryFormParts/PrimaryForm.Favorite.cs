...
{
    private Button myFavoritesButton = default!;
    private Bitmap myFavoritesNormalBackground = default!;
    private Bitmap myFavoritesActiveBackground = default!;

    private string mobileNumber = string.Empty;
    public static bool isPhoneNumberValid;
    private bool showError = false;
    private PictureBox FavoritePictureBox = default!;
    private Button[] favoriteNumberButton = default!;
    private Button enterFavoriteButton = default!;
    private Button newFavoriteButton = default!;
    private Button refillFavoriteButton = default!;
    private Button closeFavoriteButton = default!;
    private Label errorMessageLabel = default!;
