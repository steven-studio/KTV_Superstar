...
public partial class OverlayForm {
    public Label displayLabel = default!;
    public Label songDisplayLabel = default!;
    private List < Label > displayLabels = default!;
    public Label pauseLabel = default!;
    public Label muteLabel = default!; // New mute label
    public Label originalSongLabel = default!;
    public Label nextSongLabel = default!;
    private Label serviceBellLabel = default!;
    public Label volumeUpLabel = default!; // New volume up label
    public Label volumeDownLabel = default!; // New volume down label
    ...
    public Label micUpLabel = default!; // New microphone up label
    public Label micDownLabel = default!; // New microphone down label
    public Label keyUpLabel = default!; // New key up label
    public Label keyDownLabel = default!; // New key down label
    public Label standardLabel = default!; // New standard label
    public Label keyShiftLabel = default!; // New keyShift  label
    public Label squareLabel = default!; // New square label
    public Label professionalLabel = default!; // New professional label
    public Label singDownLabel = default!; // New sing down label
    public Label brightLabel = default!; // New bright label
    public Label softLabel = default!; // New soft label
    public Label autoLabel = default!; // New auto label
    public Label romanticLabel = default!; // New romantic label
    public Label dynamicLabel = default!; // New dynamic label
    public Label tintLabel = default!; // New tint label
    ...
    private void ConfigureKeyTimers() {
        ...
        standardKeyTimer.Tick += (sender, e) => {
    ...
    public Panel blackBackgroundPanel = default!;
